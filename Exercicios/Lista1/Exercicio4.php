		...
		<form action="" method="post" class="mt-4">
			<div class="d-flex flex-column align-items-start gap-2 mb-3">
				<div>
					...
					<input type="number" id="nota1" name="nota1" class="form-control" style="width: 100px;" required>
				</div>
				<div>
					<label for="nota2">Nota 2:</label>
					<input type="number" id="nota2" name="nota2" class="form-control" style="width: 100px;" required>
				</div>
				<div>
					<label for="nota3">Nota 3:</label>
					<input type="number" id="nota3" name="nota3" class="form-control" style="width: 100px;" required>
				</div>
			</div>
