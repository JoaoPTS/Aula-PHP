...
<body>
	...
	<div class="container mt-5">
		<h1 class="text-left" style="font-size: 20px;">Conversão de Temperatura F° para C°:</h1>
		<form action="" method="post" class="mt-4">
			<div class="d-flex flex-column align-items-start gap-2 mb-3">
				<div class="d-flex align-items-center gap-2">
					<label for="temp">Temperatura F°:</label>
	...
	<div class="container mt-3">
		<h2 class="text-left" style="font-size: 20px;">Resultado: <?php echo 'Temperatura ' . number_format($temp, 2, ',', '.') . 'F° = ' . number_format($temp_f, 2, ',', '.') . 'C°'; ?></h2>
	</div>
</body>
