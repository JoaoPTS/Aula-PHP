...
<body>
	...
	<div class="container mt-5">
		<h1 class="text-left" style="font-size: 20px;">Cálculo do perímetro de um retângulo:</h1>
		<form action="" method="post" class="mt-4">
			<div class="d-flex flex-column align-items-start gap-2 mb-3">
				<div class="d-flex align-items-center gap-2">
					<label for="base">Base:</label>
					<input type="number" step="0.01" min="0.01" id="base" name="base" class="form-control" style="width: 100px;" required>
				</div>
				<div class="d-flex align-items-center gap-2">
	...
	<div class="container mt-3">
		<h2 class="text-left" style="font-size: 20px;">Resultado: <?php echo 'Perímetro = ' . number_format($perimetro, 2, ',', '.'); ?></h2>
	</div>
</body>
