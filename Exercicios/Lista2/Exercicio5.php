...
<body>
	...
	<div class="container mt-5">
		<h1 class="text-left" style="font-size: 20px;">Sequência crescente até o número escolhido:</h1>
		<form action="" method="post" class="mt-4">
			<div class="d-flex flex-column align-items-start gap-2 mb-3">
        <div class="d-flex align-items-center gap-2">
          <label for="numero">Número:</label>
				  <input type="number" step="1" min="1" id="numero" name="numero" class="form-control me-2" style="width: 100px;" required>
        </div>
			</div>
    ...
    for ($i = 1; $i <= $numero; $i++) {
      echo "<p class='text-left' style='font-size: 20px;'>$i</p>";
    }
    ?>
	</div>
</body>
