...
<body>
	...
	<div class="container mt-5">
		<h1 class="text-left" style="font-size: 20px;">Contagem de caracteres de uma palavra:</h1>
	...
	<div class="container mt-3">
		<h2 class="text-left" style="font-size: 20px;">Resultado: <?php echo $contagem; ?></h2>
	</div>
</body>
