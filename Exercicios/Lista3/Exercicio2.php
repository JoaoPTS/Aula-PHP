...
<body>
	...
	<div class="container mt-5">
		<h1 class="text-left" style="font-size: 20px;">Formatar Palavra em maiusculas e minusculas:</h1>
	...
	<div class="container mt-3">
		<h2 class="text-left" style="font-size: 20px;">Palavra em maiúsculas: <?php echo $maiusculas; ?></h2>
		<h2 class="text-left" style="font-size: 20px;">Palavra em minúsculas: <?php echo $minusculas; ?></h2>
	</div>
</body>
