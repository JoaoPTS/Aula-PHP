...
<body>
	...
	<div class="container mt-5">
		<h1 class="text-left" style="font-size: 20px;">Mostrar apenas as iniciais:</h1>
		<form action="" method="post" class="mt-4">
			<div class="d-flex flex-column align-items-start gap-2 mb-3">
				<div class="d-flex align-items-center gap-2">
					<label for="nome">Nome:</label>
					<input type="text" id="nome" name="nome" class="form-control me-2" style="width: 200px;" required>
				</div>
			</div>
  ...
  <div class='container mt-3'>
    <h2 class='text-left' style='font-size: 20px;'>Resultado: </h2>
      ...
      echo "<p class='text-left' style='font-size: 20px;'>Nome original: '$nome'</p>";
      echo "<p class='text-left' style='font-size: 20px;'>Iniciais: '$iniciais'</p>";
      ?>
  </div>
</body>
