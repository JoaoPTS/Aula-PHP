...
<body>
	...
	<div class="container mt-5">
		<h1 class="text-left" style="font-size: 20px;">Retornar frase:</h1>
  ...
  <div class='container mt-3'>
    <h2 class='text-left' style='font-size: 20px;'>Resultado: </h2>
      ...
      echo "<p class='text-left' style='font-size: 20px;'>Total de palavras: '$totalPalavras'</p>";
      echo "<p class='text-left' style='font-size: 20px;'>Maior palavra: '$maiorPalavra'</p>";
      ?>
  </div>
</body>
